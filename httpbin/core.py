...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "legacy")
def view_landing_page():
    """Generates Landing Page in legacy layout."""
    return render_template("index.html")


@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "html")
def view_html_page():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "deny")
def view_deny_page():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "ip")
def view_origin():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "uuid")
def view_uuid():
    """Return a UUID4.
    ---
    tags:
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "headers")
def view_headers():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "user-agent")
def view_user_agent():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "get", methods=("GET",))
def view_get():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "anything", methods=["GET", "POST", "PUT", "DELETE", "PATCH", "TRACE"])
@app.route(
    os.environ.get("FLASGGER_URL_PREFIX", "/") + "anything/<path:anything>",
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "post", methods=("POST",))
def view_post():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "put", methods=("PUT",))
def view_put():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "patch", methods=("PATCH",))
def view_patch():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "delete", methods=("DELETE",))
def view_delete():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "gzip")
@filters.gzip
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "deflate")
@filters.deflate
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "brotli")
@filters.brotli
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "redirect/<int:n>")
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "redirect-to", methods=["GET", "POST", "PUT", "DELETE", "PATCH", "TRACE"])
def redirect_to():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "relative-redirect/<int:n>")
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "absolute-redirect/<int:n>")
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "stream/<int:n>")
...
@app.route(
    os.environ.get("FLASGGER_URL_PREFIX", "/") + "status/<codes>", methods=["GET", "POST", "PUT", "DELETE", "PATCH", "TRACE"]
)
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "response-headers", methods=["GET", "POST"])
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "cookies")
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "forms/post")
def view_forms_post():
    """Simple HTML form."""
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "cookies/set/<name>/<value>")
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "cookies/set")
def set_cookies():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "cookies/delete")
def delete_cookies():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "basic-auth/<user>/<passwd>")
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "hidden-basic-auth/<user>/<passwd>")
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "bearer")
def bearer_auth():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "digest-auth/<qop>/<user>/<passwd>")
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "digest-auth/<qop>/<user>/<passwd>/<algorithm>")
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "digest-auth/<qop>/<user>/<passwd>/<algorithm>/<stale_after>")
def digest_auth(
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "delay/<delay>", methods=["GET", "POST", "PUT", "DELETE", "PATCH", "TRACE"])
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "drip")
def drip():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "base64/<value>")
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "cache", methods=("GET",))
def cache():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "etag/<etag>", methods=("GET",))
def etag(etag):
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "cache/<int:value>")
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "encoding/utf8")
def encoding():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "bytes/<int:n>")
def random_bytes(n):
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "stream-bytes/<int:n>")
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "range/<int:numbytes>")
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "links/<int:n>/<int:offset>")
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "links/<int:n>")
def links(n):
    """Redirect to first links page."""
    return redirect(url_for("link_page", n=n, offset=0))


@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "image")
def image():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "image/png")
def image_png():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "image/jpeg")
def image_jpeg():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "image/webp")
def image_webp():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "image/svg")
def image_svg():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "xml")
def xml():
...
@app.route(os.environ.get("FLASGGER_URL_PREFIX", "/") + "json")
def a_json_endpoint():
